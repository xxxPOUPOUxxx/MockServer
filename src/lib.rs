...
#[derive(Debug)]
pub struct MockServerProcessor {
    verbose: bool,
    processed_count: usize,
}

impl MockServerProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting MockServer processing");
    
    let mut processor = MockServerProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = MockServerProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = MockServerProcessor::new(false);
